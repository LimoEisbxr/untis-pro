...
The Periodix notification system provides real-time notifications for timetable changes, access requests, and other important events. It supports both browser notifications and PWA push notifications.
