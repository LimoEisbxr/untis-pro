...
export default function UserManagerAccessManagement({
    token,
    user,
    isVisible,
}: UserManagerAccessManagementProps) {
    ...
    const handleAddRule = async () => {
        ...
        setError(null);
        try {
            const response = await userManagerAddWhitelistRule(
                token,
                newRule.trim()
            );
            if (response.created) {
        ...
        <div className="space-y-6">
            ...
            <div className="border-b border-slate-200 dark:border-slate-700 pb-4">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                    Manage whitelist rules and handle access requests as a user
                    manager
                </p>
            </div>
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            >
                                <path
                                    ...
                                    strokeWidth="2"
                                    d="M15 17h5l-5 5-5-5h5v-6h5l-5-5-5 5h5v6z"
                                />
                            </svg>
                        ...
                        {accessRequests.length > 0 ? (
                                ...
                                {accessRequests.map((request) => (
                                    ...
                                    >
                                        <div className="flex items-start justify-between">
                                            ...
                                            <div className="flex flex-col sm:flex-row ml-4 space-y-2 sm:space-y-0 sm:space-x-2 w-28 sm:w-auto">
                                                <button
                                                    onClick={() =>
                                                        handleAcceptRequest(
                                                            request.id
                                                    ...
                                                    className="w-full sm:w-auto px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition-colors flex items-center justify-center space-x-1"
                                                >
                                                    <svg
                                                        className="w-4 h-4"
                                                        fill="none"
                                                ...
                                                <button
                                                    ...
                                                    className="w-full sm:w-auto px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-lg transition-colors flex items-center justify-center space-x-1"
                                                >
                                                    <svg
                                                        className="w-4 h-4"
                                                        fill="none"
                            ...
                            <div className="text-center py-8 bg-slate-50 dark:bg-slate-800 rounded-lg border-2 border-dashed border-slate-300 dark:border-slate-600">
                                ...
                                <div className="text-xs text-slate-400 dark:text-slate-500 mt-1">
                                    Requests will appear here when users ask for
                                    access
                                </div>
                            </div>
                        )}
                    ...
                    <div className="space-y-4">
                        ...
                        {whitelistRules.length > 0 ? (
                                    ...
                                    >
                                        ...
                                        <button
                                            onClick={() => {
                                                if (
                                                    window.confirm(
                                                        `Are you sure you want to delete the whitelist rule "${rule.value}"?`
                                                    )
                                                ) {
                            ...
                            <div className="text-center py-6 bg-slate-50 dark:bg-slate-800 rounded-lg border-2 border-dashed border-slate-300 dark:border-slate-600">
                                ...
                                <div className="text-xs text-slate-400 dark:text-slate-500 mt-1">
                                    Add rules to automatically approve users
