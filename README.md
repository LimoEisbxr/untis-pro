...
The easiest way to run Untis Pro is using Docker Compose, which sets up the entire stack automatically.
...
Untis Pro requires proper environment configuration. Copy `.env.example` to `.env` and customize the following variables:
